...
EXPD_SRC = expd.c expd_rglr.c expd_sq.c expd_dq.c expd_dlr.c expd_tld.c expd_rm_empty_substrs.c expd_split_sub.c expd_split_sub_utils.c glbr.c glbr_mem.c \
